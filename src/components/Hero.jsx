...
const Hero = ({ hero: { title, subtitle, btn1, btn2, text, img } }) => {
  return (
    <div className="flex flex-col bg-gradient-to-b from-emerald-200 to-white h-auto w-auto">
      <div className="herocontainer justify-items-center grid items-start">
        <div className="grid items-center justify-items-center mt-36 mb-16 md:mt-28 md:mb-12">
          ...
          <div className="sm:w-full sm:flex-col flex justify-center items-center gap-11 sm:gap-5">
        ...
        <div className="flex items-center justify-center mb-11">
          <img
            src={img}
            alt=""
            className="image-shadow h-[85vh] w-full object-fill lg:h-[75vh] md:h-[57vh] sm:h-[35vh] "
          />
        </div>
      </div>
    </div>
